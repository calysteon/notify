// Pseudocode for function at 0x100009198
const char *__fastcall sub_100009198(const char *result, __int64 a2)
{
  const char *v3; // x20
  unsigned int v4; // w21
  unsigned int v5; // w8
        ...
        v7 && (v4 >= 0x228 ? (v8 = 552LL) : (v8 = v4), (result = (const char *)memchr(result + 40, 0, v8 - 40)) != 0LL)) )
  {
    ...
    if ( !*(_DWORD *)v9 && *((_DWORD *)v9 + 1) > 0x1Fu )
    {
      *(_QWORD *)(a2 + 32) = 0x10000000000000LL;
      ...
      v13[0] = *(_OWORD *)(v9 + 20);
      v13[1] = v12;
      result = (const char *)sub_100002784(v3 + 40, v11, (_DWORD *)(a2 + 48), (mach_port_name_t *)(a2 + 28), v13);
