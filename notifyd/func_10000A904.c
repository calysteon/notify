// Pseudocode for function at 0x10000A904
const char *__fastcall sub_10000A904(const char *result, __int64 a2)
{
  const char *v3; // x20
  unsigned int v4; // w21
  unsigned int v5; // w8
        ...
        v7 && (v4 >= 0x228 ? (v8 = 552LL) : (v8 = v4), (result = (const char *)memchr(result + 40, 0, v8 - 40)) != 0LL)) )
  {
    ...
    if ( !*(_DWORD *)v9 && *((_DWORD *)v9 + 1) > 0x1Fu )
    {
      ...
      v13[0] = *(_OWORD *)(v9 + 20);
      v13[1] = v12;
      result = (const char *)sub_100000C94(v3 + 40, (_QWORD *)(a2 + 36), (_DWORD *)(a2 + 44), v11, v13);
      *(_DWORD *)(a2 + 32) = 0;
